...
For these two specific cases, we just map the ``\texttt{source}''
...
Freebase properties included the CVTs encoding these data into Wikidata references.
\todo{Denny: Could you find a better formulation?}
