...
\category{I.2.4}{Artifical Intelligence}{Knowledge Representation}
...
\keywords{AIW: AI for Web-Based Collaboration and Cooperation, AIW: Crowdsourcing Techniques and Methodologies, KRR: Knowledge Acquisition}
...
In \autoref{sec:related-work} we discuss the relation to other work.
...
political positions held with a start and end date, or actors playing a specific character in a movie.
CVT values are much like topics, \emph{i.e.} they have a~mid and can have types
(usually only the compound value type).
