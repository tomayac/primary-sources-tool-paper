...
Entities and statements are stored in an SQL database (MySQL or SQLite) and
...
The REST API of the backend supports the following types of queries:
\begin{itemize}
