...
\todo{"There is no reference in the text to \autoref{fig:mapped-not-mapped}
(which has a lot of subtle information in it.) It needs some real explanation." -- Jamie}
...
\begin{itemize}
  ...
  \item 48M~topics
  \item 2,997M triples
  \item 442M facts redistributable by Google\todo{Better formulation?}%
